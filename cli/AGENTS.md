...
- Dev API key: `fnunf36x4wea9hz54ce1w8b1`
- Build: `zig build`
- Binary location: `./zig-out/bin/lytx`

**Example commands:**
```bash
cd cli
zig build
./zig-out/bin/lytx --base-url http://localhost:8787 --api-key fnunf36x4wea9hz54ce1w8b1 health
./zig-out/bin/lytx --base-url http://localhost:8787 --api-key fnunf36x4wea9hz54ce1w8b1 endpoints
```
