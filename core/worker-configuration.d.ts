/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: df3cd21a64d24e94b40cd857bfded6af)
// Runtime types generated with workerd@1.20251001.0 2025-08-21 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "SyncDurableObject" | "SiteDurableObject";
	}
	interface Env {
		LYTX_EVENTS: KVNamespace;
		lytx_config: KVNamespace;
		lytx_sessions: KVNamespace;
		ENVIRONMENT: string;
		BLINK_API_KEY: string;
		SUPABASE_URL: string;
		SUPABASE_KEY: string;
		EU_SUPABASE_KEY: string;
		EU_SUPABASE_URL: string;
		SUPABASE_DB_PASS: string;
		DATABASE_URL: string;
		DATABASE_URL1: string;
		WEBAUTHN_APP_NAME: string;
		ENCRYPTION_KEY: string;
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		WRANGLER_HYPERDRIVE_LOCAL_CONNECTION_STRING_lytx_pg: string;
		...
		AI_MODEL: string;
		AI_API_KEY: string;
		SYNC_DURABLE_OBJECT: DurableObjectNamespace<import("./src/worker").SyncDurableObject>;
		SITE_DURABLE_OBJECT: DurableObjectNamespace<import("./src/worker").SiteDurableObject>;
		lytx_core_db: D1Database;
		SITE_EVENTS_QUEUE: Queue;
		lytx_pg: Hyperdrive;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BLINK_API_KEY" | "SUPABASE_URL" | "SUPABASE_KEY" | "EU_SUPABASE_KEY" | "EU_SUPABASE_URL" | "SUPABASE_DB_PASS" | "DATABASE_URL" | "DATABASE_URL1" | "WEBAUTHN_APP_NAME" | "ENCRYPTION_KEY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "WRANGLER_HYPERDRIVE_LOCAL_CONNECTION_STRING_lytx_pg" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "AI_BASE_URL" | "AI_MODEL" | "AI_API_KEY">> {}
}
